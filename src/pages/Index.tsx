    ...
    <div className="min-h-screen bg-canvas">
      ...
      <section className="min-h-[90vh] flex items-center justify-center px-4 pt-16 md:pt-24 pb-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* ADONNOW MINERAL PORTAL INSTALL SECTION */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="mb-6 md:mb-8">
              <h3 className="font-heading text-xl md:text-2xl lg:text-3xl mb-3 md:mb-4 text-text-primary">
                Adonnow Mineral Portal
              </h3>
              <p className="text-text-secondary font-body text-sm md:text-base lg:text-lg max-w-2xl mx-auto mb-4 md:mb-6">
                One-click install for direct access to Africa's richest mineral deposits. Works offline.
              </p>
            </div>
            
            {/* SOVEREIGN INSTALL BUTTON - MOBILE RESPONSIVE */}
            <button 
              id="install-app"
              className="download-banner inline-block border-0 bg-transparent p-0 cursor-pointer mx-auto"
              aria-label="Install Adonnow Mineral Portal App"
            >
              <img 
                src="/images/playStore1.png" 
                alt="Install Adonnow Mineral Portal - Direct Mining Access"
                className="w-full max-w-[260px] sm:max-w-[300px] md:max-w-[340px]"
              />
            </button>
            
            <p className="tagline mt-4 md:mt-6 text-xs md:text-sm lg:text-base max-w-xl mx-auto px-2">
              Install directly to your device • No app store • Works offline • 24/7 Mining Desk Access
            </p>
            
            <div className="mt-6 md:mt-8 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 max-w-2xl mx-auto">
              <div className="text-center p-3 md:p-4 rounded-[14px] md:rounded-[18px] bg-canvas-dark/50 border border-border">
                <div className="text-text-highlight font-bold text-sm md:text-base mb-1">One-Click</div>
                <div className="text-text-secondary text-[10px] md:text-xs">Instant Install</div>
              </div>
              <div className="text-center p-3 md:p-4 rounded-[14px] md:rounded-[18px] bg-canvas-dark/50 border border-border">
                <div className="text-text-highlight font-bold text-sm md:text-base mb-1">Live Prices</div>
                <div className="text-text-secondary text-[10px] md:text-xs">Real-time Data</div>
              </div>
              <div className="text-center p-3 md:p-4 rounded-[14px] md:rounded-[18px] bg-canvas-dark/50 border border-border">
                <div className="text-text-highlight font-bold text-sm md:text-base mb-1">24/7 Desk</div>
                <div className="text-text-secondary text-[10px] md:text-xs">Direct Access</div>
              </div>
              <div className="text-center p-3 md:p-4 rounded-[14px] md:rounded-[18px] bg-canvas-dark/50 border border-border">
                <div className="text-text-highlight font-bold text-sm md:text-base mb-1">Verified</div>
                <div className="text-text-secondary text-[10px] md:text-xs">Mine Data</div>
              </div>
            </div>
          </motion.div>
        </div>
