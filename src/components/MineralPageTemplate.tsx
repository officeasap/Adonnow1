...
const MineralPageTemplate = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <DepthContainer elevation={3} className={`p-6 md:p-8 mb-8 ${bgGradient}`}>
      ...
      <div className="space-y-8">
        {sections.map((section, index) => (
          ...
          >
            <DepthContainer elevation={2} className="p-6 md:p-8">
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="relative">
                  {section.image ? (
                    ...
                    <DepthContainer elevation={1} className="h-64 md:h-80 flex items-center justify-center">
      ...
      <motion.div
        ...
        className="mt-12"
      >
        <DepthContainer elevation={3} className="p-8 text-center">
